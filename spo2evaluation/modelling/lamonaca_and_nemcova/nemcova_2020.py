...
class Nemcova2020(object):
    ...
    def ppg_filtered(self, frames, sampling_rate):
        ...
        vps_940_green_filtered_normalized = self.cutoff_fir(
            vps_green_normalized, 3.2, sampling_rate
        )
        vps_600_red_filtered_normalized = self.cutoff_fir(
            vps_red_normalized, 2.2, sampling_rate
        )
    ...
    def ppg_filtered_from_video_file(self, video_file):
        ...
        while cap.isOpened():
            ...
            if ret == True:
                ...
                blue_channel_mean, green_channel_mean, red_channel_mean = self.ppg_nemcova(
                    frame
                )
        ...
        return (
            ppg_green_filtered_normalized,
            ppg_full_green,
            ppg_red_filtered_normalized,
            ppg_full_red,
            ppg_full_blue,
            duration,
            timestamps,
    ...
    def spo2_estimation(self, video_file, optimize=True):
        ...
        print("Estimation")
        spo2, hr = utils.spo2_estimation(
            ppg_green_filtered_normalized, ppg_red_filtered_normalized, timestamps, fps
        )
