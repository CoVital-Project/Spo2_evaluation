...
class Lamonaca2015(object):
    ...
    def ppg_lamonaca(self, frame, blue = 0, green = 1, red = 2):
        ...
        vp_600_green = green_channel_mean * (self.camera_specs.qe_green_940 / self.camera_specs.sum_qe_green_600_to_940)
        vp_600_red = red_channel_mean * (self.camera_specs.qe_red_600 / self.camera_specs.sum_qe_red_600_to_940)
    ...
    def lacomana(self, video_file):
        print("lacoma")
        vps_940_green_filtered, vps_600_red_filtered, duration, timestamps = self.ppg_filtered_from_video_file(video_file)
